...
void KisImage::keyframeChannelHasBeenAdded(KisNode *node, KisKeyframeChannel *channel)
{
    ...
    channel->connect(channel, SIGNAL(sigMovingKeyframe(const KisKeyframeChannel*, int, const KisKeyframeChannel* , int, KUndo2Command*)),
                     m_d->animationInterface, SIGNAL(sigMovingKeyframeBetween(const KisKeyframeChannel*, int, const KisKeyframeChannel*, int, KUndo2Command*)), Qt::UniqueConnection);
}

void KisImage::keyframeChannelAboutToBeRemoved(KisNode *node, KisKeyframeChannel *channel)
{
    Q_UNUSED(node);
    channel->disconnect(channel, SIGNAL(sigAddedKeyframe(const KisKeyframeChannel*, int, KUndo2Command*)),
                     m_d->animationInterface, SIGNAL(sigAddedKeyframeTo(const KisKeyframeChannel*, int, KUndo2Command*)));
    channel->disconnect(channel, SIGNAL(sigRemovingKeyframe(const KisKeyframeChannel*,int, KUndo2Command*)),
                     m_d->animationInterface, SIGNAL(sigRemovingKeyframeFrom(const KisKeyframeChannel*, int, KUndo2Command*)));
    channel->disconnect(channel, SIGNAL(sigMovingKeyframe(const KisKeyframeChannel*, int, const KisKeyframeChannel* , int, KUndo2Command*)),
                     m_d->animationInterface, SIGNAL(sigMovingKeyframeBetween(const KisKeyframeChannel*, int, const KisKeyframeChannel*, int, KUndo2Command*)));
}
